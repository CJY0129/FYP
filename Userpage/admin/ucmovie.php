...
<div class="page-content">
        ...
        $_SESSION['m']=3;
if (isset($_GET['show']) && $_GET['show'] == 'ucmovie') 
{
...
?>
        ...
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Upcoming Movies details            </li>
          </ul>
        </div>
        <section class="no-padding-top">
            <div class="container-fluid">
                ...
                <div class="block margin-bottom-sm">
                  <div class="title"><strong>Upcoming Movies details </strong></div>
