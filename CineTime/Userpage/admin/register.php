                        ...
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    $checkUserSql = "SELECT * FROM admin WHERE username='$admin_username' OR Email='$admin_email' OR PhoneNumber='$admin_phone'";
                                    $result = $conn->query($checkUserSql);

                                    if ($result->num_rows > 0) {
                                        echo "<div class='alert alert-danger'>Error: Username , Phone Number or email address already exists</div>";
                                    } else {
